...
<div class="container">
  <div class="row">
    <div id="brand_carouse" class="owl-carousel brand-logo">
        ...
        <div class="item text-center"> <a href="#"><img src="{{url('public')}}/frontend/image/brand/brand11.png" alt="Canon" class="img-responsive" /></a> </div>
        <div class="item text-center"> <a href="#"><img src="{{url('public')}}/frontend/image/brand/brand12.png" alt="Canon" class="img-responsive" /></a> </div>
        ...
        <div class="item text-center"> <a href="#"><img src="{{url('public')}}/frontend/image/brand/brand14.png" alt="Canon" class="img-responsive" /></a> </div>
        <div class="item text-center"> <a href="#"><img src="{{url('public')}}/frontend/image/brand/brand15.png" alt="Canon" class="img-responsive" /></a> </div>
  ...
  <div class="row">
    <div id="content" class="col-sm-12">
      <h3 class="productblock-title" style="text-align: center;">Sản phẩm nổi bật</h3>
      <div class="box">
